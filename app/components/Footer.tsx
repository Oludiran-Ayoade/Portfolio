...
export default function Footer() {
  ...
  return (
    <footer className="py-8 bg-[#f0ebe3] border-t border-stone-200/60">
      <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <a
          href="#home"
          className="flex items-center gap-2 text-amber-600 font-mono font-bold hover:text-amber-700 transition-colors"
        >
          <Code2 size={18} />
          <span className="text-sm">OAE</span>
        </a>

        <p className="text-stone-400 text-xs text-center font-mono">
